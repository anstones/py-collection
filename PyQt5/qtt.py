...
class MessageBox(QtWidgets.QWidget):#继承自父类QtWidgets.QWidget
    ...
    def __init__(self,parent = None):#parent = None代表此QWidget属于最上层的窗口,也就是MainWindows.
        QtWidgets.QWidget.__init__(self)#因为继承关系，要对         #通过super初始化父类，__init__()函数无self，若直接QtWidgets.QWidget.__init__(self)，括号里是有self的
        ...
        self.window_pale.setBrush(self.backgroundRole(),QtGui.QBrush(QtGui.QPixmap("23.jpg")))#打开图片
