...
def get_one_page(i):
    try:
        ...
        url = 'http://s.askci.com/stock/h/?' + urlencode(paras)
...
def parse_one_page(html):
    ...
    tbl.rename(columns={'序号': 'serial_number', '股票代码': 'stock_code', '股票简称': 'stock_abbre', '公司名称': 'company_name',
                        '注册地址': 'register_address', '主营业务收入(201712)': 'main_bussiness_income',
...
def generate_mysql():
    ...
    sql = 'CREATE TABLE IF NOT EXISTS listed_company2 (serial_number INT(20) NOT NULL,stock_code VARCHAR(20) ,stock_abbre VARCHAR(20) ,company_name VARCHAR(20) ,register_address VARCHAR(20) ,main_bussiness_income VARCHAR(20) ,net_profit VARCHAR(20) ,employees INT(20) ,listing_date DATETIME(0) ,zhaogushu VARCHAR(20) ,financial_report VARCHAR(20) , industry_classification VARCHAR(100),main_business VARCHAR(200) ,PRIMARY KEY (serial_number))'
