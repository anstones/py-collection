...
class TestingItem(models.Model):
    ...
    testing_type = models.ForeignKey(TestingType, verbose_name=u"标准类别", on_delete=models.CASCADE)
    class Meta:
        verbose_name = '测试项目'
...
class Contract(models.Model):
    ...
    customer = models.ForeignKey(Customer,related_name='contracts',verbose_name=u"委托单位", on_delete=models.CASCADE)
