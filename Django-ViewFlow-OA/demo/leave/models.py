...
class Leave(models.Model):
    ...
    depart_name = models.ForeignKey(department,verbose_name=u'部门', on_delete=models.CASCADE)
    position =  models.CharField(max_length=256,  verbose_name=u"职位")
    req_class =models.ForeignKey(Leave_class,verbose_name=u'请假类别', on_delete=models.CASCADE)
